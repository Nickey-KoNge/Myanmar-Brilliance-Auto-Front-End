...
import { faArrowsRotate, faCamera, faCar, faChargingStation, faCircleCheck, faDriversLicense, faIdCard, faUser } from "@fortawesome/free-solid-svg-icons";
...
export const VehicleForm:React.FC<VehicleFormProps> = ({
    ...
    if (initialData) {
        ...
        // If your API returns an image URL string, show it in the preview
    ...
    return (
        ...
        <PageHeader
            titleData={{
                ...
                description: mode === "create" ? "CREATE NEW VEHICLE" : "UPDATE VEHICLE",
            }}
        ...
        <form id="vehicleForm" onSubmit={handleSubmit(onSubmit)} className={styles.page}>
            ...
            <DropdownInput
                ...
                <DropdownInput
                    ...
                    {...register("vehicle_model_id", { required: mode === "create" ? "Vehicle model is required" : false })}
